...
public class DeathGui extends Gui {
    ...
    public DeathGui(Minecraft p_93005_) {
    ...
    protected void renderHearts(PoseStack p_168689_, Player p_168690_, int p_168691_, int p_168692_, int p_168693_, int p_168694_, float p_168695_, int p_168696_, int p_168697_, int p_168698_, boolean p_168699_) {
        DeathGui.HeartType gui$hearttype = DeathGui.HeartType.forPlayer(p_168690_);
        ...
        for(int i1 = j + k - 1; i1 >= 0; --i1) {
            ...
            this.renderHeart(p_168689_, DeathGui.HeartType.CONTAINER, l1, i2, i, p_168699_, false);
            int j2 = i1 * 2;
            boolean flag = i1 >= j;
            if (flag) {
                int k2 = j2 - l;
                if (k2 < p_168698_) {
                    ...
                    this.renderHeart(p_168689_, gui$hearttype == DeathGui.HeartType.WITHERED ? gui$hearttype : DeathGui.HeartType.ABSORBING, l1, i2, i, false, flag1);
                }
            }
    ...
    private void renderHeart(PoseStack p_168701_, DeathGui.HeartType p_168702_, int p_168703_, int p_168704_, int p_168705_, boolean p_168706_, boolean p_168707_) {
    ...
    static enum HeartType {
        ...
        static HeartType forPlayer(Player p_168733_) {
            DeathGui.HeartType gui$hearttype;
